...
def printMap(V):
    ...
    for heal in healers:
        ...
        map_matrix[a+1][b] = healColor(heal) + Fore.BLACK + '  '
        map_matrix[a][b+1] = healColor(heal) + Fore.BLACK + 'AL'
    ...
    for arch in stealtharchers:
        a= 2*arch.position[0]
        b = 2*arch.position[1]
        map_matrix[a][b] = stealtharchColor(arch) + Fore.BLACK + 'ST'
        map_matrix[a+1][b] = stealtharchColor(arch) + Fore.BLACK + 'AR '
        map_matrix[a][b+1] = stealtharchColor(arch) + Fore.BLACK + 'CH'
        map_matrix[a+1][b+1] = stealtharchColor(arch) + Fore.BLACK + 'ER'
